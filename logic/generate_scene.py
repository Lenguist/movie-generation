...
2. Do not include more than 8 words of narration in each scene.
...
6. Write formulaic proofs as much as you can

7. Write the whole code in one chunk at every code generation stage.
8. Always write python code between ```python ```.
9. You are allowed to import manim, import numpy as np.
10. DO NOT INCLUDE ANY OUTSIDE GRAPHICS OR IMAGES. ONLY USE MANIM.
"""
